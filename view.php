...
elseif ($category == 'advanced') {
    switch($func){
        ...
        case 'BINARY':
            $sql = "SELECT BINARY name AS result FROM employees";
            $columns = ['result'];
            break;
        ...
        case 'CONVERT':
            $sql = "SELECT CONVERT(salary, CHAR) AS result FROM employees";
            $columns = ['result'];
            break;
        ...
        case 'IF':
            $sql = "SELECT name, IF(salary>40000,'High','Low') AS result FROM employees";
            $columns = ['name','result'];
            break;
        ...
        case 'ISNULL':
            $sql = "SELECT name, ISNULL(bonus) AS result FROM employees";
            $columns = ['name','result'];
            break;
